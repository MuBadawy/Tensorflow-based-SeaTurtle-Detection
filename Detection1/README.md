...
1. [Installing TensorFlow-GPU](https://github.com/MuBadawy/Tensorflow-based-SeaTurtle-Detection/Detection1#1-install-tensorflow-gpu-15-skip-this-step-if-tensorflow-gpu-15-is-already-installed)
